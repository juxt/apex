...
(ns juxt.apex.dev.server
  (:require
   ...
   [juxt.apex.alpha2.trace-console :as console]
...
#_(extend-protocol StreamableResponseBody
...
;;(r/match-by-name (create-root-router {}) :pets-api)
;;(r/route-names (create-root-router {}))
